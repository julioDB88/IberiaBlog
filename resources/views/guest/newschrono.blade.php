...
<h1 class="text-lg md:text-3xl text-indigo-700 text-center font-bold tracker">{{Carbon\Carbon::createFromFormat('Y-m',$date)->locale('es')->monthName}} {{Carbon\Carbon::createFromFormat('Y-m',$date)->year}}</h1>
