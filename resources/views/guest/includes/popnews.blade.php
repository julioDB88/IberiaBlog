        ...
        <div class="p-4 ">
            <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center"
                    src="{{asset('storage/posts')}}/{{$post->img_file}}" alt="blog">
                <div class="p-6">
                    <h1 class="title-font text-lg font-medium text-gray-900 mb-1">{{$post->title}}</h1>
                    ...
                    <p class="leading-relaxed mb-3">{{ mb_strimwidth($post->description,0,95,'...') }}</p>
                    <div class="flex items-center flex-wrap ">
                        <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0"
                            href="{{route('news.show',$post->slug)}}">{{__('Read More')}}
